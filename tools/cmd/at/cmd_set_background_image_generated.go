...
io_data.multiple_payload_generator, err = read_background_image(io_data, args[0])
...
ans.Add(cli.OptionSpec{
            ...
            Type: "bool-set",
            Dest: "Configured",
            Help: "Change the configured background image which is used for new OS windows. Note that an index with this option is not supported. Specifying :code:`none` will erase *all* configured background images.",
        })
ans.Add(cli.OptionSpec{
            Name: "--layout",
            Type: "choices",
